...
{
	/*
	 * This variable of type integer it checks prime till number 50 Note that this.It is also private to be protected from other class
	 * value "50" is fixed while checking if the code doing write functionality or
	 * not
	 */
	private int n = 50;
	
	// This setter to set value 
